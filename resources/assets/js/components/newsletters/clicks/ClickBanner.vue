...
<script>
    ...
    export default {
        ...
        methods: {
            getClicks(){
                axios.get('api/clicks/' + this.$route.params.newsletter + '/banners/' + this.$route.params.banner + '/clicks')
                    .then(res => {
            ...
            clickToLink(index){
                axios.get('api/clicks/' + this.$route.params.newsletter + '/banners/' + this.$route.params.banner + '/clicks?page=' + index)
                    .then(res => {
                        this.clicks = res.data.clicks.data;
                        this.paginate = res.data.clicks;
                    })
