    ...
    <div id="place">
        <div class="container-fluid">
                ...
                <div class="col-md-12">
                    <div id="breadcrumbs">
                        <ul class="list-group list-group-flush">
                            ...
                            <li>Izmena banerske pozicije</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row bela">
                <div class="col-md-12">
                    <div class="card">
                        <h5>Izmena banerske pozicije</h5>
                    </div>
                </div>

                <div class="col-sm-8">
                    <div class="card">
                        <form @submit.prevent="submit()" v-if="position">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            submit(){
                let data = fillForm(this.fillable, this.position, 'PUT')
                axios.post('api/positions/' + this.position.id, data)
                    .then(res => {
                        this.position = res.data.position;
                        swal({
                            position: 'center',
