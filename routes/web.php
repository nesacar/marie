 ...
 */
Route::get('marie-claire-preporucuje', 'Web\BeautyBoxesController@beautyBox');
Route::get('marie-claire-preporucuje/{category}', 'Web\BeautyBoxesController@beautyBoxCategory');
